...
const ProductCard = ({ product, style }) => {
  ...
  // Get card style from theme config or use passed style prop
  const cardStyle = style || 
    (themeConfig?.settings?.layout?.productCardStyle || 'standard');
  ...
  return (
    <div className="product-card" data-style={cardStyle}>
      <Link to={`/products/${id}`} className="product-link">
        <div className="product-image-container">
          <img 
            src={imageUrl || '/assets/placeholder-images/product.jpg'} 
